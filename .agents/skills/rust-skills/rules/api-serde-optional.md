...
```rust
// OK: Required: Library is about serialization
// (e.g., json-schema, config-file parser)
[dependencies]
serde = "1.0"

// OK: Required: Domain heavily uses serde
// (e.g., API client, data format library)

// BAD: Optional: General-purpose utility library
// BAD: Optional: Math/algorithm library
// BAD: Optional: Most libraries!
```
